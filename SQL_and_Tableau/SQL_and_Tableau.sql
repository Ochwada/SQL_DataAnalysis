...
ORDER BY dm.emp_no,
    ...
    -- Compare the average salary of female versus male employees in the entire company until year 2002, and add a 
    -- filter allowing you to see that per each department.
SELECT e.gender,
    d.dept_name,
...
-- and female salary per department within a certain salary range. Let this 
